...
<div class="content">
  ...
  <el-row class="main_content">
    <el-table :data="userList" style="width: 100%;" align="center" :row-class-name="tableRowClassName">
      ...
      <el-table-column align="center" width="100" label="密码">
        <template slot-scope="scope">
...
.el-table {
  ...
  /* 如果值为collapse，则element表格下方会出现滚动条*/
}
