...
<div>
  <el-container>
    ...
    <el-dialog title="视频任务分配" :visible.sync="showAssignTask">

      <el-form :model="taskForm">
        <el-form-item label="标签" :label-width="formLabelWidth">
          <span>{{taskForm.tagName}}({{taskForm.maxCount}}个)</span>
        </el-form-item>
...
export default {
  data() {
    return {
      ...
      getAllTagsUrl: 'video/getUnAssignedVideoList',
      assignTaskUrl: 'video/assignVideoTaskToUser',
  ...
  methods: {
    ...
    assignTask() {
      ...
      params.append('assignTo', this.taskForm.taskOwner);
      params.append('assignCount', this.taskForm.assignCount);
      params.append('labelName', this.taskForm.tagName);
