    ...
    <div class='select-tag-box'>
      ...
      <div class="button-box">
        <span class="commit-box">
          ...
          <el-button type="primary" round @click="setStart();playVideo()" v-show='start==false'>▶ 播放</el-button>
          <el-button type="primary" round @click="setStop()" v-show="start==true">▮ 停止</el-button>
        </span>
